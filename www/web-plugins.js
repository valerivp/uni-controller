...
$plugins['clock-at-logo'] = new clockAtLogo_class();
...
$plugins['sensor-data-sender'] = new sensorDataSender_class();
...
$plugins['sensors-ds18b20'] = new sensorsDs18b20_class();
...
$plugins['sensors-pzem004t'] = new sensorsPzem004t_class();
...
$plugins['sensors-wth433'] = new sensorsWth433_class();
...
$plugins['time-schema'] = new timeSchema_class();
...
$plugins['time-schema-temperature'] = new timeSchemaTemperature_class();
...
$plugins['mqtt-udp-publicator'] = new mqttUdpPublicator_class();
...
$plugins['tile-energy-monitor'] = new tileEnergyMonitor_class();
...
$plugins['tile-temperature-humidity-battery'] = new tileTemperatureHumidityBattery_class();

/* time-schema-humidity v.0.0.1 */

function timeSchemaHumidity_class(){
...
$plugins['time-schema-humidity'] = new timeSchemaHumidity_class();

/* time-schema-onoff v.0.0.1 */

function timeSchemaOnoff_class(){
...
$plugins['time-schema-onoff'] = new timeSchemaOnoff_class();
